...
namespace Kartverket.Test
{
    public class CsvTests
    {
        ...
        public void CaseWorkerTestCsvFileReading()
        {
            ...
            Assert.Single(records); // Assuming the CSV file has 1 record
        ...
        public void FylkeInfoTestCsvFileReading()
        {
            ...
            // Assert
            Assert.NotNull(records);
            Assert.Equal(15, records.Count()); // Assuming the CSV file has 3 records
        ...
        public void KommuneInfoTestCsvFileReading()
        {
            ...
            // Assert
            Assert.NotNull(records);
            Assert.Equal(357, records.Count()); // Assuming the CSV file has 3 records
        ...
        public void StatusTestCsvFileReading()
        {
            ...
            // Assert
            Assert.NotNull(records);
            Assert.Equal(5, records.Count()); // Assuming the CSV file has 3 records
        ...
        public void KartverketEmployeeTestCsvFileReading()
        {
            ...
            // Assert
            Assert.NotNull(records);
            Assert.Equal(21, records.Count()); // Assuming the CSV file has 3 records
